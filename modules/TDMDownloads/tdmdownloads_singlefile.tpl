    ...
    <div class="tdm-download-data row">
        ...
        <div class="col-sm-4 col-md-4">
            <ul class="list-unstyled tdm-download-details">
                ...
                <li><a class="btn btn-xs btn-primary" href="<{$xoops_url}>/modules/tdmdownloads/brokenfile.php?lid=<{$lid}>" title="<{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_REPORTBROKEN}>"><{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_REPORTBROKEN}></a>
                </li>
