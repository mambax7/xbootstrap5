...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr style="text-align:center;">
            <th rowspan="2">&nbsp;</th>
            <td colspan="2" class="even"><a href="<{$xoops_url}>/modules/extcal/view_calendar-month.php?<{$navig.prev.uri}>">
                    << <{$navig.prev.name}></a></td>
            <td colspan="3" class="even"><span style="font-weight:bold;"><{$navig.this.name}></span>
            </td>
            <td colspan="2" class="even"><a href="<{$xoops_url}>/modules/extcal/view_calendar-month.php?<{$navig.next.uri}>"><{$navig.next.name}>
                    >></a></td>
        </tr>
        ...
        <tr>
            <th style="text-align:center; vertical-align:middle;"><a href="view_calendar-week.php?year=<{$row.weekInfo.year}>&month=<{$row.weekInfo.month}>&day=<{$row.weekInfo.day}>"><{$row.weekInfo.week}></a>
            </th>
