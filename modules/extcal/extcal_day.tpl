...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr style="text-align:center;">
            <td class="even" style="width:33%;"><a href="<{$xoops_url}>/modules/extcal/day.php?<{$navig.prev.uri}>">
                    <<&nbsp;&nbsp;<{$navig.prev.name}></a></td>
            <td class="even" style="width:33%;"><span style="font-weight:bold;"><{$navig.this.name}></span>
            </td>
            <td class="even" style="width:33%;"><a href="<{$xoops_url}>/modules/extcal/day.php?<{$navig.next.uri}>"><{$navig.next.name}>&nbsp;&nbsp;>></a>
            </td>
        </tr>
        <tr>
