<div class="usermenu">
    <ul class="nav flex-column">
        <{if isset($xoops_isadmin)}>
            <li class="nav-item"><a class="nav-link" href="<{xoAppUrl 'admin.php'}>" title="<{$block.lang_adminmenu}>"><span class="fa fa-wrench"></span><{$block.lang_adminmenu}></a></li>
            <li class="nav-item"><a class="nav-link" href="<{xoAppUrl 'user.php'}>" title="<{$block.lang_youraccount}>"><span class="fa fa-user"></span><{$block.lang_youraccount}></a></li>
        <{else}>
        ...
        <{/if}>
        <li class="nav-item"><a class="nav-link" href="<{xoAppUrl 'edituser.php'}>" title="<{$block.lang_editaccount}>"><span class="fa fa-pencil"></span><{$block.lang_editaccount}></a></li>
        <li class="nav-item"><a class="nav-link" href="<{xoAppUrl 'notifications.php'}>" title="<{$block.lang_notifications}>"><span class="fa fa-info-sign"></span><{$block.lang_notifications}></a></li>
